...
public class MedicalRecordRepository implements IMedicalRecordRepository {
    ...
    private final static String GET_ALL_DTO = "select medical_record.id, medical_record.record_id, start_date,end_date,description, patient.name as patient_name\n" +
            "from medical_record \n" +
    ...
    private final static String SEARCH_DTO = "SELECT medical_record.id, medical_record.start_date, end_date,description, patient.name AS patient_name\n" +
            "FROM medical_record\n" +
            "JOIN patient ON patient.patient_id = medical_record.patient_id\n" +
